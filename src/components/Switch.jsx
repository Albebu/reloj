export function Switch({ onChange }) {
    return (
        <label onChange={onChange} className="inline-flex items-center relative">
            ...
            <svg
                ...
                id="Layer_1"
                xmlns="http://www.w3.org/2000/svg"
                className="fill-black opacity-80 peer-checked:opacity-70 peer-checked:fill-white absolute w-6 h-6 right-[13px]"
            >
                <path
